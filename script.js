...
const SUPABASE_KEY =
    "ضع_مفتاح_anon_او_publishable_هنا";
...
async function loadReservedSeats() {
    ...
    try {
        ...
        showMessage(
            "تعذر تحميل المقاعد. تأكد من إعداد Supabase.",
            false
        );
    ...
    try {
        ...
        */
        ...
        if (
            ...
            throw new Error(
                `المقاعد ${conflict.join(" ، ")} تم حجزها بالفعل.`
            );
        }
